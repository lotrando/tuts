        ...
        <div class="tab-content">
          ...
          <div class="tab-pane" id="tab-top-2" role="tabpanel">
            <div class="card-body">
              ...
              <figure class="highlight">
                <pre class="m-0 p-0"><code class="php">Route::get('routes', function () {
    $pageinfo = [
        'title'    => 'Routes',
        'subtitle' => 'All about laravel routes',
    ];
    return view('routes', compact('pageinfo'));
})->name('routes');</code></pre>
              </figure>
            </div>
          </div>
          <!-- Content of card #3 -->
          <div class="tab-pane" id="tab-top-3" role="tabpanel">
            <div class="card-body">
              ...
              <p class="text-secondary">
                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Adipisci, alias aliquid distinctio molestias odit.
              </p>
            </div>
          </div>
